package com.rdeclerck.springbootrestserver.model;
...
import com.rdeclerck.springbootrestserver.dto.UserDTO;
...
public class User implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5004262660847576179L;
...
*/
	...
	public String toString() {
		return "User [id=" + id + ",login =" + login + ",password=XXXXXXXX, active=" + active + ",roles=" + roles + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (login == null) {
			if (other.login != null)
				return false;
		}else if(!password.contentEquals(other.password))
			return false;
		if (roles == null) {
			if(other.roles != null)
				return false;
